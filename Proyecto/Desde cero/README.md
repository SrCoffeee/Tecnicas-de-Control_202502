...
Este proyecto fue desarrollado como parte de [Nombre del Curso] en [Universidad].

**Autores:**
- [Tu Nombre] - Control PID y H∞
- [Nombre 2] - Control SMC
- [Nombre 3] - Control APID y RLS
- [Nombre 4] - Implementación y pruebas
...
- 🔗 GitHub: [https://github.com/tu-usuario/proyecto-controladores](https://github.com)
- 💼 LinkedIn: [Tu perfil]
