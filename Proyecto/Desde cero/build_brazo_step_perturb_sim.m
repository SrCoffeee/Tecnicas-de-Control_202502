...
set_param([mdl '/SMC_ctrl'],'MATLABFcn',...
['function u = SMC_ctrl(e,omega,theta,ref,Ts)', newline, ...
 '%#codegen', newline, ...
 'lambda = 3.0; k_torque = 0.01; phi = 0.5;', newline, ...
 's = omega + lambda*e;', newline, ...
 'persistent ref_prev; if isempty(ref_prev), ref_prev = ref; end', newline, ...
 'ref_dot = (ref - ref_prev)/Ts; ref_prev = ref;', newline, ...
